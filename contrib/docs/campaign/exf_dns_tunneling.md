...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `exf_dns_tunneling`. In the local catalog, the attack is described as: DNS tunneling exfiltration behavior through random domain name resolution. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/exf_dns_tunneling`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/exf_dns_tunneling`
