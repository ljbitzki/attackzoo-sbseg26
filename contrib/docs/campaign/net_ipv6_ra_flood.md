...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `net_ipv6_ra_flood`. In the local catalog, the attack is described as: ICMPv6 Router Advertisement RA (134) flood on the local network. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/net_ipv6_ra_flood`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/net_ipv6_ra_flood`
