...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `net_stp_tcn_flood`. In the local catalog, the attack is described as: BPDU (Bridge Protocol Data Unit) packet flood with STP topology change information and random MAC addresses. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/net_stp_tcn_flood`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/net_stp_tcn_flood`
