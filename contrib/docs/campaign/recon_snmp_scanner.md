...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `recon_snmp_scanner`. In the local catalog, the attack is described as: SNMP scan across all hosts in a network using a community-string wordlist. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/recon_snmp_scanner`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/recon_snmp_scanner`
