...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `iot_zenoh_pico_fragments_reassembly`. In the local catalog, the attack is described as: Flood of incomplete Zenoh/Zenoh-Pico fragments to stress router or peer buffers and reassembly logic. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/iot_zenoh_pico_fragments_reassembly`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/iot_zenoh_pico_fragments_reassembly`
