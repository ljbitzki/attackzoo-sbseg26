...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `web_idor_url_parameter`. In the local catalog, the attack is described as: Attempts to access resources through URL parameter manipulation using a wordlist. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/web_idor_url_parameter`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/web_idor_url_parameter`
