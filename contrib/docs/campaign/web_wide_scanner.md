...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `web_wide_scanner`. In the local catalog, the attack is described as: Broad scanner for known web vulnerabilities. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/web_wide_scanner`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/web_wide_scanner`
