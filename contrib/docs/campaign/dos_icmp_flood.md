...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `dos_icmp_flood`. In the local catalog, the attack is described as: ICMP packet flood. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/dos_icmp_flood`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/dos_icmp_flood`
