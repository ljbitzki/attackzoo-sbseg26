...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `web_https_heartbleed`. In the local catalog, the attack is described as: Heartbleed scanner/exploitation against a vulnerable HTTPS server. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/web_https_heartbleed`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/web_https_heartbleed`
