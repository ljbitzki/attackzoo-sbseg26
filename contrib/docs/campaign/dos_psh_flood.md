...
In campaign `experiments/60att_5runs_l0l1l2l3`, this document consolidates the execution of attack `dos_psh_flood`. In the local catalog, the attack is described as: TCP packet flood with the PSH flag set. The documentation below uses only artifacts already present in the repository, mainly the tables and figures from `experiments/60att_5runs_l0l1l2l3/dos_psh_flood`.
...
- Campaign artifacts: `experiments/60att_5runs_l0l1l2l3/dos_psh_flood`
