...
> TCP packet flood with the SYN flag set.
...
| MITRE ATT&CK | [https://attack.mitre.org/tactics/TA0040/](https://attack.mitre.org/tactics/TA0040/)<br>[https://attack.mitre.org/techniques/T1498/001/](https://attack.mitre.org/techniques/T1498/001/) |
...
```bash
python3 attackzoo.py run dos_syn_flood --target <TARGET>
```

Run the container directly for isolated validation:

```bash
docker run --rm -d --name attack-syn-flood attack-syn-flood:latest "<TARGET_IP>" "8080"
```
