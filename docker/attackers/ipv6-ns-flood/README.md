# Attack "IPv6 NS Flood"

> ICMPv6 Neighbor Solicitation NS (135) flood on the local network.
...
| MITRE ATT&CK | [https://attack.mitre.org/tactics/TA0007/](https://attack.mitre.org/tactics/TA0007/)<br>[https://attack.mitre.org/techniques/T1018/](https://attack.mitre.org/techniques/T1018/)<br>[https://attack.mitre.org/techniques/T1595/001/](https://attack.mitre.org/techniques/T1595/001/) |
...
```bash
python3 attackzoo.py run net_ipv6_ns_flood --target <TARGET>
```

Run the container directly for isolated validation:

```bash
docker run --rm -d --name attack-ipv6-ns-flood attack-ipv6-ns-flood:latest
```
